...
pub fn create_router(gateway: Gateway) -> Router {
    ...
    let router = Router::new()
        // Apply DefaultBodyLimit per-route so axum-core's extractor
        // picks up the DefaultBodyLimitKind extension.  Router-level
        // .layer() doesn't always propagate it through nested layers.
